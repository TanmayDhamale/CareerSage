...
# df["job_search_count"] = np.random.randint(1, 10, df.shape[0])  # Simulating past searches
# df["career_switches"] = np.random.randint(0, 5, df.shape[0])  # Simulating past transitions

# # Balance Dataset (Handle Career Imbalance)
